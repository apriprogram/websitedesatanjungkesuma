        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <div class="flex items-center justify-center h-full w-full p-6">
                    <img src="{{ asset('img/logo/favicon_logo_lampung_timur.png') }}" alt="Logo Lampung Timur"
                        class="w-auto h-auto max-h-[200px] object-contain transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6">
                </div>
