...
class DashboardController extends Controller
{
    ...
    public function seedVillageData(): RedirectResponse
    {
        $pages = [
            'sejarah-desa' => [
        ...
        return redirect()->back()->with('success', 'Data informasi Desa Tanjung Kesuma berhasil diperbarui secara otomatis!');
    }
}
