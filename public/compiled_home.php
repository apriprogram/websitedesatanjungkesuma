...
<body>
    ...
    <!-- Footer -->
    <?php echo $__env->make('frontend.partials.footer', ['socialLinks' => $socialLinks ?? collect(), 'publicInfoSetting' => $publicInfoSetting ?? null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    ?>
    <script>
        window.isUserAuthenticated = <?php echo json_encode(auth()->check(), 15, 512) ?>;
        window.__NEWS_DATA__ = <?php echo json_encode($newsData, 15, 512) ?>;
        window.__ANNOUNCEMENT_DATA__ = <?php echo json_encode($announcementData, 15, 512) ?>;
        window.__STAT_DATA__ = <?php echo json_encode($statistikData ?? [], 15, 512) ?>;
    </script>
    <script>
    ...
    <script src="<?php echo e(asset('assets/js/accessibility.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\Users\ASUS\Videos\WEB DEVELOPER\WEBSITE DESA TANJUNG KESUMA OK\Website Tanjung Kesuma\resources\views/frontend/home.blade.php ENDPATH**/ ?>